...
name: gws-drive
version: 1.0.0
description: "Files in Google Drive through the gws CLI: search, upload, download, move, share, set permissions, browse shared drives. Reach for it as soon as a document is looked for in Drive, filed there, or shared with someone."
metadata:
  openclaw:
