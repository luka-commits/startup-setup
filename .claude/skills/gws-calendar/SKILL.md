...
name: gws-calendar
version: 1.0.0
description: "Appointments through the gws CLI: list calendars, search events, create, move, cancel, answer invitations, check availability. Reach for it as soon as a single appointment is looked up or changed — for the plain day view gws-calendar-agenda is enough."
metadata:
  openclaw:
