...
version: 1.0.0
description: "Append a row to the bottom of a Google Sheet — carry on a tracker, add a lead or an entry, log a run. Leaves existing rows untouched. Reading is gws-sheets-read."
metadata:
  openclaw:
