...
name: gws-gmail
version: 1.0.0
description: "The mailbox through the gws CLI: search and read threads, fetch attachments, label, archive, create and send drafts. Reach for it as soon as the content or state of a mail matters — sending a finished mail is gws-gmail-send."
metadata:
  openclaw:
