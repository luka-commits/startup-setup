...
name: gws-gmail-send
version: 1.0.0
description: "Send a finished mail through the gws CLI: recipient, subject, body, attachment, CC. Sending only. Searching the mailbox, reading threads, labelling and drafting is gws-gmail."
metadata:
  openclaw:
