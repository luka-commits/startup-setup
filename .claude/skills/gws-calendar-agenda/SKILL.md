...
version: 1.0.0
description: "What is coming up — the next appointments across all calendars in one list. The quick read path for today, tomorrow, this week. Changing or creating an appointment is gws-calendar."
metadata:
  openclaw:
