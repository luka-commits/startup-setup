...
- **Nie Daten an fremde Dienste hochladen.** Kein Export, keine eigene Datenbank, kein Dienst des Paket-Autors. Die EINE Ausnahme, die du selbst einrichtest: Beim Tagesabschluss sichert das System den Stand dieses Ordners in **dein eigenes privates GitHub-Repo** (das aus Schritt 1 der Einrichtung) — dein Konto, dein Zugriff, jederzeit abschaltbar (Repo-Verbindung entfernen). Sonst nirgendwohin.
